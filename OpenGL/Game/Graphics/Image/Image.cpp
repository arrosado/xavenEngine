...
void Image::Render() {
    ...
    if (this->dirty) {
        ...
        c->Write("[bottom left (%f,%f)]", this->imageDetails->texturedColoredQuadIVA->vertex1.geometryVertex.x,
                 this->imageDetails->texturedColoredQuadIVA->vertex1.geometryVertex.y);
        
        c->Write("[bottom right (%f,%f)]", this->imageDetails->texturedColoredQuadIVA->vertex2.geometryVertex.x,
                 this->imageDetails->texturedColoredQuadIVA->vertex2.geometryVertex.y);
        
        c->Write("[top left (%f,%f)]", this->imageDetails->texturedColoredQuadIVA->vertex3.geometryVertex.x,
                 this->imageDetails->texturedColoredQuadIVA->vertex3.geometryVertex.y);
        
        c->Write("[top right (%f,%f)]", this->imageDetails->texturedColoredQuadIVA->vertex4.geometryVertex.x,
                 this->imageDetails->texturedColoredQuadIVA->vertex4.geometryVertex.y);
