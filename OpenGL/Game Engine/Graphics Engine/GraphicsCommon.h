#ifndef __XGEGRAPHICS_COMMON_H__
#define __XGEGRAPHICS_COMMON_H__
...
static const Size2Df Size2DfZero = {0.0f, 0.0f};
...
static inline void scaleMatrix(float aMatrix[], Vector2Df aScale) {
...
#endif /* __XGEGRAPHICS_COMMON_H__ */